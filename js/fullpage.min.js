! function(e, t, n, o, r) { "function" == typeof define && define.amd ? define(function() { return e.fullpage = o(t, n), e.fullpage }) : "object" == typeof exports ? module.exports = o(t, n) : t.fullpage = o(t, n) }(this, window, document, function(wt, yt) {
    "use strict";
    ...
    function on(e, t) { wt.console && wt.console[e] && wt.console[e]("fullPage: " + t) }

    function rn(e, t) { return (t = 1 < arguments.length ? t : yt) ? t.querySelectorAll(e) : null }
    ...
    function an(e, t) { return null != e && (e.classList ? e.classList.contains(t) : new RegExp("(^| )" + t + "( |$)", "gi").test(e.className)) }

    function sn() { return "innerHeight" in wt ? wt.innerHeight : yt.documentElement.offsetHeight }
    ...
    function n(e, t, n) { for (var o = e[n]; o && !Hn(o, t);) o = o[n]; return o }

    function un(e, t) { return n(e, t, "previousElementSibling") }

    function fn(e, t) { return n(e, t, "nextElementSibling") }

    function dn(e) { return e.previousElementSibling }
    ...
    function gn(e) { e = l(e); for (var t = 0; t < e.length; t++) e[t].style.display = "none"; return e }

    function mn(e) { e = l(e); for (var t = 0; t < e.length; t++) e[t].style.display = "block"; return e }
    ...
    function wn(e, t) { t.appendChild(e) }
    ...
    function yn(e, t) { o(e, t, !0) }

    function En(e, t) { for ("string" == typeof t && (t = Rn(t)), e.appendChild(t); e.firstChild !== t;) t.appendChild(e.firstChild) }
    ...
    function xn(e, t) { return e && 1 === e.nodeType ? Hn(e, t) ? e : xn(e.parentNode, t) : null }

    function An(e, t) { r(e, e.nextSibling, t) }

    function Tn(e, t) { r(e, e, t) }

    function r(e, t, n) { i(n) || ("string" == typeof n && (n = Rn(n)), n = [n]); for (var o = 0; o < n.length; o++) e.parentNode.insertBefore(n[o], t) }

    function kn() { var e = yt.documentElement; return (wt.pageYOffset || e.scrollTop) - (e.clientTop || 0) }

    function Mn(t) { return Array.prototype.filter.call(t.parentNode.children, function(e) { return e !== t }) }

    function On(e) { e.preventDefault ? e.preventDefault() : e.returnValue = !1 }

    function Cn(e) { if ("function" == typeof e) return !0; var t = Object.prototype.toString(e); return "[object Function]" === t || "[object GeneratorFunction]" === t }

    function In(e, t, n) {
        var o;
        n = void 0 === n ? {} : n, "function" == typeof wt.CustomEvent ? o = new CustomEvent(t, { detail: n }) : (o = yt.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, n), e.dispatchEvent(o)
    }

    function Hn(e, t) { return (e.matches || e.matchesSelector || e.msMatchesSelector || e.mozMatchesSelector || e.webkitMatchesSelector || e.oMatchesSelector).call(e, t) }
    ...
    function Rn(e) { var t = yt.createElement("div"); return t.innerHTML = e.trim(), t.firstChild }
    ...
    function a(e, t, n) { for (var o = e[n], r = []; o;)(Hn(o, t) || null == t) && r.push(o), o = o[n]; return r }

    function jn(e, t) { return a(e, t, "nextElementSibling") }

    function Nn(e, t) { return a(e, t, "previousElementSibling") }
    return wt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) { t = t || wt; for (var n = 0; n < this.length; n++) e.call(t, this[n], n, this) }), wt.fp_utils = { $: rn, deepExtend: ln, hasClass: an, getWindowHeight: sn, css: cn, until: n, prevUntil: un, nextUntil: fn, prev: dn, next: vn, last: pn, index: hn, getList: l, hide: gn, show: mn, isArrayOrList: i, addClass: Sn, removeClass: bn, appendTo: wn, wrap: o, wrapAll: yn, wrapInner: En, unwrap: Ln, closest: xn, after: An, before: Tn, insertBefore: r, getScrollTop: kn, siblings: Mn, preventDefault: On, isFunction: Cn, trigger: In, matches: Hn, toggle: Bn, createElementFromHTML: Rn, remove: zn, filter: function(e, t) { Array.prototype.filter.call(e, t) }, untilAll: a, nextAll: jn, prevAll: Nn, showError: on },
        function(e, E) {
            ...
            if (!an(rn("html"), kt)) {
                ...
                v.k = ln({}, v.m);
                var p, s, m, S, k, M, b, w, y = wt.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" },
                    O = { touchmove: "ontouchmove" in wt ? "touchmove" : y.move, touchstart: "ontouchstart" in wt ? "touchstart" : y.down },
                ...
                pt(), wt.fp_easings = ln(wt.fp_easings, { easeInOutCubic: function(e, t, n, o) { return (e /= o / 2) < 1 ? n / 2 * e * e * e + t : n / 2 * ((e -= 2) * e * e + 2) + t } }), f && (h.version = "3.0.2", h.setAutoScrolling = U, h.setRecordHistory = W, h.setScrollingSpeed = X, h.setFitToSection = _, h.setLockAnchors = function(e) { E.lockAnchors = e }, h.setMouseWheelScrolling = K, h.setAllowScrolling = q, h.setKeyboardScrolling = Q, h.moveSectionUp = G, h.moveSectionDown = J, h.silentMoveTo = Z, h.moveTo = ee, h.moveSlideRight = te, h.moveSlideLeft = ne, h.fitToSection = de, h.reBuild = oe, h.setResponsive = re, h.getFullpageData = E, h.destroy = function(e) {
                    ...
                    }), $e(f), [jt, qt, _t].forEach(function(e) { rn(e, f).forEach(function(e) { Ln(e) }) }), cn(f, { "-webkit-transition": "none", transition: "none" }), wt.scrollTo(0, 0), [Ht, Ft, Kt].forEach(function(e) { bn(rn("." + e), e) }))
                }, h.getActiveSection = function() { return new St(rn(Rt)[0]) }, h.getActiveSlide = function() { return Ae(rn(Wt, rn(Rt)[0])[0]) }, h.test = { top: "0px", translate3d: "translate3d(0px, 0px, 0px)", translate3dH: function() { for (var e = [], t = 0; t < rn(E.sectionSelector, f).length; t++) e.push("translate3d(0px, 0px, 0px)"); return e }(), left: function() { for (var e = [], t = 0; t < rn(E.sectionSelector, f).length; t++) e.push(0); return e }(), options: E, setAutoScrolling: U }, h.shared = { afterRenderActions: ue }, wt.fullpage_api = h, E.css3 && (E.css3 = function() {
                    ...
                    if (!E.anchors.length) {
                        ...
                        t.length && (H = !0, t.forEach(function(e) { E.anchors.push(e.getAttribute("data-anchor").toString()) }))
                    }
                    ...
                    cn(f, { height: "100%", position: "relative" }), Sn(f, Et), Sn(rn("html"), kt), A = sn(), bn(f, Tt), Sn(rn(E.sectionSelector, f), Ht), Sn(rn(E.slideSelector, f), Ft);
                    for (var e = rn(Bt), t = 0; t < e.length; t++) {
                        var n = t,
                            o = e[t],
                            r = rn(Ut, o),
                            i = r.length;
                        o.setAttribute("data-fp-styles", o.getAttribute("style")), s = o, (c = n) || null != rn(Rt)[0] || Sn(s, Ot), u = rn(Rt)[0], cn(s, { height: A + "px" }), E.paddingTop && cn(s, { "padding-top": E.paddingTop }), E.paddingBottom && cn(s, { "padding-bottom": E.paddingBottom }), void 0 !== E.sectionsColor[c] && cn(s, { "background-color": E.sectionsColor[c] }), void 0 !== E.anchors[c] && s.setAttribute("data-anchor", E.anchors[c]), l = o, a = n, void 0 !== E.anchors[a] && an(l, Ot) && Qe(E.anchors[a], a), E.menu && E.css3 && null != xn(rn(E.menu)[0], Lt) && L.appendChild(rn(E.menu)[0]), 0 < i ? se(o, r, i) : E.verticalCentered && Je(o)
                    }
                    var l, a, s, c;
                    E.fixedElements && E.css3 && rn(E.fixedElements).forEach(function(e) { L.appendChild(e) }), E.navigation && function() {
                        ...
                        rn("ul", n)[0].innerHTML = o, cn(rn(Vt), { "margin-top": "-" + rn(Vt)[0].offsetHeight / 2 + "px" }), Sn(rn("a", rn("li", rn(Vt)[0])[hn(rn(Rt)[0], Bt)]), Ot)
            ...
            function U(e, t) {
                ...
                var n = rn(Rt)[0];
                if (E.autoScrolling && !E.scrollBar) cn(r, { overflow: "hidden", height: "100%" }), W(I.recordHistory, "internal"), cn(f, { "-ms-touch-action": "none", "touch-action": "none" }), null != n && ut(n.offsetTop);
                else if (cn(r, { overflow: "visible", height: "initial" }), W(!1, "internal"), cn(f, { "-ms-touch-action": "", "touch-action": "" }), null != n) {
                    var o = Te(n.offsetTop);
                    o.element.scrollTo(0, o.options)
                }
            }

            function W(e, t) { vt("recordHistory", e, t) }

            function X(e, t) { vt("scrollingSpeed", e, t) }

            function _(e, t) { vt("fitToSection", e, t) }
            ...
            function q(t, e) { void 0 !== e ? (e = e.replace(/ /g, "").split(",")).forEach(function(e) { dt(t, e, "m") }) : dt(t, "all", "m") }

            function $(e) {
                e ? (K(!0), function() {
                    if (n || o) {
                        E.autoScrolling && (L.removeEventListener(O.touchmove, pe, { passive: !1 }), L.addEventListener(O.touchmove, pe, { passive: !1 }));
                        var e = rn(Lt)[0];
                        e && (e.removeEventListener(O.touchstart, me), e.removeEventListener(O.touchmove, he, { passive: !1 }), e.addEventListener(O.touchstart, me), e.addEventListener(O.touchmove, he, { passive: !1 }))
                    }
                }()) : (K(!1), function() {
                    if (n || o) {
                        E.autoScrolling && (L.removeEventListener(O.touchmove, he, { passive: !1 }), L.removeEventListener(O.touchmove, pe, { passive: !1 }));
                        var e = rn(Lt)[0];
                        e && (e.removeEventListener(O.touchstart, me), e.removeEventListener(O.touchmove, he, { passive: !1 }))
                    }
                }())
            }

            function Q(t, e) { void 0 !== e ? (e = e.replace(/ /g, "").split(",")).forEach(function(e) { dt(t, e, "k") }) : (dt(t, "all", "k"), E.keyboardScrolling = t) }
            ...
            function Z(e, t) { X(0, "internal"), ee(e, t), X(I.scrollingSpeed, "internal") }
            ...
            function te(e) { we("right", e) }

            function ne(e) { we("left", e) }
                ...
                if (!an(f, Tt)) {
                    ...
                    for (var t = rn(Bt), n = 0; n < t.length; ++n) {
                        var o = t[n],
                            r = rn(_t, o)[0],
                            i = rn(Ut, o);
                        E.verticalCentered && cn(rn(jt, o), { height: Ze(o) + "px" }), cn(o, { height: A + "px" }), 1 < i.length && We(r, rn(Wt, r)[0])
                    }
            ...
            function ie(e) {
                ...
                t && xn(t, Vt + " a") ? function(e) {
                    ...
                    Ee(rn(Bt)[t])
                }.call(t, e) : Hn(t, ".fp-tooltip") ? function() { In(dn(this), "click") }.call(t) : Hn(t, Zt) ? function() {
                    var e = xn(this, Bt);
                    ...
                    We(t, n)
                }.call(t, e) : xn(t, E.menu + " [data-menuanchor]") && function(e) {!rn(E.menu)[0] || !E.lockAnchors && E.anchors.length || (On(e), ee(this.getAttribute("data-menuanchor"))) }.call(t, e)
            }

            function le(e, t) { yt["fp_" + e] = t, yt.addEventListener(e, ae, !0) }

            function ae(t) { t.target != yt && E.normalScrollElements.split(",").forEach(function(e) { null != xn(t.target, e) && $(yt["fp_" + t.type]) }) }
            ...
            function se(e, t, n) {
                ...
                s.className = Kt, yn(t, s), cn(rn(qt, e), { width: o + "%" }), 1 < n && (E.controlArrows && (l = e, a = [Rn('<div class="fp-controlArrow fp-prev"></div>'), Rn('<div class="fp-controlArrow fp-next"></div>')], An(rn(_t, l)[0], a), "#fff" !== E.controlArrowColor && (cn(rn(nn, l), { "border-color": "transparent transparent transparent " + E.controlArrowColor }), cn(rn(tn, l), { "border-color": "transparent " + E.controlArrowColor + " transparent transparent" })), E.loopHorizontal || gn(rn(tn, l))), E.slidesNavigation && function(e, t) {
                    ...
                    cn(n, { "margin-left": "-" + n.innerWidth / 2 + "px" }), Sn(rn("a", rn("li", n)[0]), Ot)
                }(e, n)), t.forEach(function(e) { cn(e, { width: r + "%" }), E.verticalCentered && Je(e) });
                var c = rn(Wt, e)[0];
                null != c && (0 !== hn(rn(Rt), Bt) || 0 === hn(rn(Rt), Bt) && 0 !== hn(c)) ? ct(c, "internal") : Sn(t[0], Ot)
            }

            function ce(e, t) { return E.navigationTooltips[e] || E.anchors[e] || t + " " + (e + 1) }

            function ue() {
                var e, t = rn(Rt)[0];
                Sn(t, It), Oe(t), Ce(t), E.scrollOverflow && E.scrollOverflowHandler.afterLoad(), (!(e = tt(je().section)) || void 0 !== e && hn(e) === hn(u)) && Cn(E.afterLoad) && Le("afterLoad", { activeSection: null, element: t, direction: null, anchorLink: t.getAttribute("data-anchor"), sectionIndex: hn(t, Bt) }), Cn(E.afterRender) && Le("afterRender")
            }
            ...
            function fe() {
                ...
                if (!E.autoScrolling || E.scrollBar) {
                    ...
                    if (t = a, n = rn(Rt)[0].offsetTop, o = n + sn(), ("up" != t ? n <= kn() : o >= kn() + sn()) && (an(rn(Rt)[0], It) || (Sn(rn(Rt)[0], It), bn(Mn(rn(Rt)[0]), It))), !an(e = f[s], Ot)) {
                        ...
                        w && (p = w.getAttribute("data-anchor"), v = hn(w)), T && (Sn(e, Ot), bn(Mn(e), Ot), Cn(E.onLeave) && Le("onLeave", y), Cn(E.afterLoad) && Le("afterLoad", y), He(h), Oe(e), Ce(e), Qe(S, b - 1), E.anchors.length && (x = S), rt(v, p, S)), clearTimeout(k), k = setTimeout(function() { B = !1 }, 100)
                    }
                    E.fitToSection && (clearTimeout(M), M = setTimeout(function() { E.fitToSection && rn(Rt)[0].offsetHeight <= A && de() }, E.fitToSectionDelay))
                }
            }

            function de() { T && (g = !0, Ee(rn(Rt)[0]), g = !1) }
            ...
            function pe(e) { E.autoScrolling && ge(e) && On(e) }
            ...
            function ge(e) { return void 0 === e.pointerType || "mouse" != e.pointerType }
            ...
            function Se(e, t) { for (var n = 0, o = e.slice(Math.max(e.length - t, 1)), r = 0; r < o.length; r++) n += o[r]; return Math.ceil(n / t) }
            ...
            function ye() { for (var e = rn(Wt), t = 0; t < e.length; t++) ct(e[t], "internal") }
            ...
            function Ee(e, t, n) {
                if (null != e) {
                    ...
                    if (!(d.activeSection == e && !g || E.scrollBar && kn() === d.dtop && !an(e, Nt))) {
                        if (null != d.activeSlide && (u = d.activeSlide.getAttribute("data-anchor"), f = hn(d.activeSlide)), !d.localIsResizing) { var v = d.yMovement; if (void 0 !== n && (v = n ? "up" : "down"), d.direction = v, Cn(E.onLeave) && !1 === Le("onLeave", d)) return }
                        E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? Tn(rn(Rt)[0], jn(p.activeSection, Bt)) : An(rn(Rt)[0], Nn(p.activeSection, Bt).reverse()), ut(rn(Rt)[0].offsetTop), ye(), p.wrapAroundElements = p.activeSection, p.dtop = p.element.offsetTop, p.yMovement = Ge(p.element), p.leavingSection = hn(p.activeSection, Bt) + 1, p.sectionIndex = hn(p.element, Bt), d = p), d.localIsResizing || He(d.activeSection), E.scrollOverflow && E.scrollOverflowHandler.beforeLeave(), Sn(e, Ot), bn(Mn(e), Ot), Oe(e), E.scrollOverflow && E.scrollOverflowHandler.onLeave(), T = h.test.isTesting, rt(f, u, d.anchorLink, d.sectionIndex),
                            function(e) {
                                if (E.css3 && E.autoScrolling && !E.scrollBar) {
                                    ...
                                    et(t, !0), E.scrollingSpeed ? (clearTimeout(m), m = setTimeout(function() { ke(e) }, E.scrollingSpeed)) : ke(e)
                                } else {
                                    var n = Te(e.dtop);
                                    h.test.top = -e.dtop + "px", ht(n.element, n.options, E.scrollingSpeed, function() { E.scrollBar ? setTimeout(function() { ke(e) }, 30) : ke(e) })
                                }
            ...
            function Me(e, t) { e.setAttribute(t, e.getAttribute("data-" + t)), e.removeAttribute("data-" + t) }
            ...
            function Ce(e) {
                var t = Be(e);
                rn("video, audio", t).forEach(function(e) { e.hasAttribute("data-autoplay") && "function" == typeof e.play && e.play() }), rn('iframe[src*="youtube.com/embed/"]', t).forEach(function(e) { e.hasAttribute("data-autoplay") && Ie(e), e.onload = function() { e.hasAttribute("data-autoplay") && Ie(e) } })
            }

            function Ie(e) { e.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*") }
            ...
            function Be(e) { var t = rn(Wt, e); return t.length && (e = t[0]), e }
            ...
            function Ne(e) {
                ...
                9 === n ? function(e) {
                    ...
                    function f(e) { return On(e), u[0] ? u[0].focus() : null }(t = e, n = Ye(yt), o = n.indexOf(yt.activeElement), r = t.shiftKey ? o - 1 : o + 1, i = n[r], l = Ae(xn(i, Ut)), a = xe(xn(i, Bt)), l || a) && (c ? null == xn(c, Rt + "," + Rt + " " + Wt) && (c = f(e)) : f(e), (!s && c == u[u.length - 1] || s && c == u[0]) && On(e))
            ...
            function Pe(e) { l && (c = e.ctrlKey) }

            function De(e) { 2 == e.which && (Y = e.pageY, f.addEventListener("mousemove", Ue)) }

            function Ve(e) { 2 == e.which && f.removeEventListener("mousemove", Ue) }

            function Ye(e) { return [].slice.call(rn(C, e)).filter(function(e) { return "-1" !== e.getAttribute("tabindex") && null !== e.offsetParent }) }

            function Fe() { c = l = !1 }

            function Ue(e) { T && (e.pageY < Y && v.m.up ? G() : e.pageY > Y && v.m.down && J()), Y = e.pageY }

            function We(e, t, n) {
                var o, r, i = xn(e, Bt),
                    l = { slides: e, destiny: t, direction: n, destinyPos: { left: t.offsetLeft }, slideIndex: hn(t), section: i, sectionIndex: hn(i, Bt), anchorLink: i.getAttribute("data-anchor"), slidesNav: rn(Gt, i)[0], slideAnchor: lt(t), prevSlide: rn(Wt, i)[0], prevSlideIndex: hn(rn(Wt, i)[0]), localIsResizing: g };
                l.xMovement = (o = l.prevSlideIndex, r = l.slideIndex, o == r ? "none" : r < o ? "left" : "right"), l.localIsResizing || (T = !1), E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && Cn(E.onSlideLeave) && !1 === Le("onSlideLeave", l) ? a = !1 : (Sn(t, Ot), bn(Mn(t), Ot), l.localIsResizing || (He(l.prevSlide), Oe(t)), !E.loopHorizontal && E.controlArrows && (Bn(rn(tn, i), 0 !== l.slideIndex), Bn(rn(nn, i), null != vn(t))), an(i, Ot) && !l.localIsResizing && rt(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex), function(e, t, n) {
                    ...
                    if (E.css3) {
                        ...
                        h.test.translate3dH[t.sectionIndex] = r, cn(qe(rn(qt, e)), ft(r)), S = setTimeout(function() { n && Xe(t) }, E.scrollingSpeed)
                    } else h.test.left[t.sectionIndex] = Math.round(o.left), ht(e, Math.round(o.left), E.scrollingSpeed, function() { n && Xe(t) })
                }(e, l, !0))
            }
            ...
            function _e() {
                if (Ke(), n) {
                    ...
                    if (!Hn(e, "textarea") && !Hn(e, "input") && !Hn(e, "select")) {
                        var t = sn();
                        Math.abs(t - F) > 20 * Math.max(F, t) / 100 && (s = setTimeout(function() { oe(!0), F = t }, navigator.userAgent.match("CriOS") ? 50 : 0))
                    }
                } else clearTimeout(s), s = setTimeout(function() { oe(!0) }, 350)
            }
            ...
            function qe(e) { var t = "all " + E.scrollingSpeed + "ms " + E.easingcss3; return bn(e, At), cn(e, { "-webkit-transition": t, transition: t }) }

            function $e(e) { return Sn(e, At) }
            ...
            function et(e, t) { t ? qe(f) : $e(f), cn(f, ft(e)), h.test.translate3d = e, setTimeout(function() { bn(f, At) }, 10) }
            ...
            function nt(e, t) {
                ...
                if (null != n) {
                    ...
                    lt(n) === x || an(n, Ot) ? ot(l) : Ee(n, function() { ot(l) })
                }
            }

            function ot(e) { null != e && We(xn(e, _t), e) }
            ...
            function st(e) { var t = []; return t.y = void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, t.x = void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, o && ge(e) && E.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY, t.x = e.touches[0].pageX), t }

            function ct(e, t) { X(0, "internal"), void 0 !== t && (g = !0), We(xn(e, _t), e), void 0 !== t && (g = !1), X(I.scrollingSpeed, "internal") }

            function ut(e) {
                var t = Math.round(e);
                if (E.css3 && E.autoScrolling && !E.scrollBar) et("translate3d(0px, -" + t + "px, 0px)", !1);
                else if (E.autoScrolling && !E.scrollBar) cn(f, { top: -t + "px" }), h.test.top = -t + "px";
                else {
                    var n = Te(t);
            ...
            function dt(t, e, n) { "all" !== e ? v[n][e] = t : Object.keys(v[n]).forEach(function(e) { v[n][e] = t }) }

            function vt(e, t, n) { E[e] = t, "internal" !== n && (I[e] = t) }
            ...
            function pt() {
                t || /*(on("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"), on("error", "https://github.com/alvarotrigo/fullPage.js#options.")),*/ an(rn("html"), kt) ? on("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (E.continuousVertical && (E.loopTop || E.loopBottom) && (E.continuousVertical = !1, on("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !E.scrollOverflow || !E.scrollBar && E.autoScrolling || on("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !E.continuousVertical || !E.scrollBar && E.autoScrolling || (E.continuousVertical = !1, on("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), E.scrollOverflow && null == E.scrollOverflowHandler && (E.scrollOverflow = !1, on("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")), ["fadingEffect", "continuousHorizontal", "scrollHorizontally", "interlockedSlides", "resetSliders", "responsiveSlides", "offsetSections", "dragAndMove", "scrollOverflowReset", "parallax"].forEach(function(e) { E[e] && on("warn", "fullpage.js extensions require fullpage.extensions.min.js file instead of the usual fullpage.js. Requested: " + e) }), E.anchors.forEach(function(t) {
                    var e = [].slice.call(rn("[name]")).filter(function(e) { return e.getAttribute("name") && e.getAttribute("name").toLowerCase() == t.toLowerCase() }),
            ...
            function gt(e, t) {!E.autoScrolling || E.scrollBar || e.self != wt && an(e, Xt) ? e.self != wt && an(e, Xt) ? e.scrollLeft = t : e.scrollTo(0, t) : e.style.top = t + "px" }

            function mt(e, t) { this.anchor = e.getAttribute("data-anchor"), this.item = e, this.index = hn(e, t), this.isLast = this.index === e.parentElement.querySelectorAll(t).length - 1, this.isFirst = !this.index }

            function St(e) { mt.call(this, e, Bt) }

            function bt(e) { mt.call(this, e, Ut) }
            pt()
        }
    ...
    n && o ? n.fn.fullpage = function(e) {
        ...
        Object.keys(t).forEach(function(e) { n.fn.fullpage[e] = t[e] })
